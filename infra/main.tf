...
module "users" {
  ...
  streamlit_public_key_path   = var.streamlit_public_key_path
  ...
  streamlit_default_namespace = module.database.dev_schema_fqdn
}
...
module "ui" {
  ...
  sf_stage            = module.database.raw_stage_name
